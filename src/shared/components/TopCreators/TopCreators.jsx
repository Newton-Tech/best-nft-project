  ...
  return (
    <div className="inline-flex h-fit w-full flex-col items-center justify-start gap-[3.75rem] bg-zinc-800 py-20">
      <div className={`flex w-full justify-between`}>
        ...
        <div>
          <Button className="flex h-[3.75rem] w-[15.4375rem] items-center justify-center  gap-3 rounded-2xl border border-purple-500  bg-transparent text-center text-[1rem] font-semibold leading-snug text-white ">
      ...
      <div
        className={`m-auto grid w-full grid-cols-4 flex-wrap items-start justify-between gap-[1.875rem]`}
      >
