...
export const CreateAccount = () => {
  return (
    <div className="w-full h-[691px] bg-zinc-800 justify-start items-center gap-[60px] inline-flex">
      <div className="w-1/2">
      ...
      <div className={`w-1/2 h-full`}>
        <div className="w-full h-[691px] py-[100px] flex-col justify-start items-start gap-10 inline-flex">
          ...
          {/*  */}
          <form className="w-full flex-col justify-center gap-5 items-start inline-flex">
            <div className="w-[330px] h-[46px]">
              <Input
            ...
            <Button
              className={`w-[330px] h-[46px] px-[50px] bg-purple-500 rounded-2xl justify-center items-center gap-3 inline-flex`}
            >
